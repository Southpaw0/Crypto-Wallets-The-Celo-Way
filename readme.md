...
Also, on some of these wallet options, these different tokens have unique wallets. Pay attention to this to avoid making Celo Dollar payments, for instance, to an only Celo wallet addressesaddress. 

Overall, the list of wallets you have above includes your recommended options as a Celo user or developer. 

## Next Steps​

Going forward, ensure you do your own research on any of these wallet options that interest you before using them. That way, you can learn their "How Tos" as well as other necessary details about them. 
